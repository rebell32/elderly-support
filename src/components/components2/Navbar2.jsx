    ...
    return(
        <div className='absolute w-full flex justify-between p-4 items-center'>
            ...
            <div className={nav 
                ...
                <ul className='flex flex-col fixed w-full h-full items-center justify center'>
                    <a href='/' className='font-bold text-2xl p-6'>Home</a>
                    <a href="/hospitals" className='font-bold text-2xl p-6'>Hospitals</a>
                    <a href="/hospices" className='font-bold text-2xl p-6'>Hospices</a>
                    <a href="/nursinghomes" className='font-bold text-2xl p-6'>Nursing Homes</a>
                    <a href="/companions" className='font-bold text-2xl p-6'>Companions</a>
                    <a href="/pharmacies" className='font-bold text-2xl p-6'>Pharmacies</a>
                    <a href="/volunteers" className='font-bold text-2xl p-6'>Volunteer Signup</a>
